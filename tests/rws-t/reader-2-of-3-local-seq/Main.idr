...
main : IO ()
main = do
  putStrLn . show =<< runRWST {m=IO} {w=()} (the Nat 10   , the Double 16, "three"   ) () action
  putStrLn . show =<< runRWST {m=IO} {w=()} (the Double 16, the Nat 10   , "three"   ) () action
  putStrLn . show =<< runRWST {m=IO} {w=()} ("one"        , the Double 16, the Nat 10) () action
  putStrLn . show =<< runRWST {m=IO} {w=()} (the Double 16, "two"        , the Nat 10) () action
